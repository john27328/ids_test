...
// uEyeInvertImage.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CuEyeInvertImageApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CuEyeInvertImageApp construction

CuEyeInvertImageApp::CuEyeInvertImageApp()
{
...
// The one and only CuEyeInvertImageApp object

CuEyeInvertImageApp theApp;


// CuEyeInvertImageApp initialization

BOOL CuEyeInvertImageApp::InitInstance()
{
