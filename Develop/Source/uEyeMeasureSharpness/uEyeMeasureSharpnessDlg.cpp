...
void CuEyeMeasureSharpnessDlg::OnBnClickedButtonResetAoi()
{
    ...
    {
        sharpnessInfo.rcAOI.s32Width	= 0;
        sharpnessInfo.rcAOI.s32Height	= 0;
    }
...
void DisplayControl::OnPaint()
{
    ...
    for (INT i = 0; i < 5 ; i++)
    {
        ...
        /* Scale positions */
        s32PosX  = (INT)((double)s32PosX * m_pParent->m_f64FactorX);
        s32PosY  = (INT)((double)s32PosY * m_pParent->m_f64FactorY);
        s32PosX2 = (INT)((double)s32PosX2 * m_pParent->m_f64FactorX);
        s32PosY2 = (INT)((double)s32PosY2 * m_pParent->m_f64FactorY);
...
void DisplayControl::OnLButtonUp(UINT nFlags, CPoint point)
{
    if ((m_nStartX != -1) && (m_nCurrX != -1))
    {
        ...
        m_pParent->m_sharpnessInfo[m_pParent->m_nCurrentAOI].rcAOI.s32X = (INT)((double)m_nStartX / m_pParent->m_f64FactorX);
        m_pParent->m_sharpnessInfo[m_pParent->m_nCurrentAOI].rcAOI.s32Y = (INT)((double)m_nStartY / m_pParent->m_f64FactorY);
        m_pParent->m_sharpnessInfo[m_pParent->m_nCurrentAOI].rcAOI.s32Width = (INT)((double)(m_nCurrX - m_nStartX + 1) / m_pParent->m_f64FactorX);
        m_pParent->m_sharpnessInfo[m_pParent->m_nCurrentAOI].rcAOI.s32Height = (INT)((double)(m_nCurrY - m_nStartY + 1) / m_pParent->m_f64FactorY);
