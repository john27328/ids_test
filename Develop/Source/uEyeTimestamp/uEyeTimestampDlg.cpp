...
extern CuEyeTimestampApp theApp;
...
/////////////////////////////////////////////////////////////////////////////
CuEyeTimestampDlg::CuEyeTimestampDlg(CWnd* pParent /*=NULL*/)
    : CDialog(CuEyeTimestampDlg::IDD, pParent)
...
void CuEyeTimestampDlg::DoDataExchange(CDataExchange* pDX)
{
    CDialog::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CuEyeTimestampDlg, CDialog)
    ON_WM_SYSCOMMAND()
    ON_WM_PAINT()
    ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
BOOL CuEyeTimestampDlg::OnInitDialog()
{
    CDialog::OnInitDialog();
...
void CuEyeTimestampDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CuEyeTimestampDlg::OnPaint()
{
    if (IsIconic())
    {
...
HCURSOR CuEyeTimestampDlg::OnQueryDragIcon()
{
...
//
///////////////////////////////////////////////////////////////////////////////
void CuEyeTimestampDlg::OnButtonStart()
{ 
    if( m_hCam == 0 )
    {
        OpenCamera();
...
//
///////////////////////////////////////////////////////////////////////////////
void CuEyeTimestampDlg::OnButtonStop()
{
...
//
///////////////////////////////////////////////////////////////////////////////
void CuEyeTimestampDlg::OnBnClickedButtonResetCounters()
{
    // Reset the counters
    m_nFrameEvents = 0;
    m_nTriggerEvents = 0;
...
//
///////////////////////////////////////////////////////////////////////////////
void CuEyeTimestampDlg::OnBnClickedButtonLoadParameter()
{
    if ( m_hCam == 0 )
        OpenCamera();
    ...
    if ( m_hCam != 0 )
    {
        if( is_ParameterSet(m_hCam, IS_PARAMETERSET_CMD_LOAD_FILE, NULL, NULL) == IS_SUCCESS)
        {
            ...
            INT nRet = AllocImageMems(m_nSizeX, m_nSizeY, m_nBitsPerPixel);
...
//
///////////////////////////////////////////////////////////////////////////////
void CuEyeTimestampDlg::OnButtonExit()
{
    ExitCamera();
    PostQuitMessage( 0 );
}
...
//
///////////////////////////////////////////////////////////////////////////////
bool CuEyeTimestampDlg::OpenCamera()
{
...
//
///////////////////////////////////////////////////////////////////////////////
LRESULT CuEyeTimestampDlg::OnUEyeMessage( WPARAM wParam, LPARAM lParam )
{
    UpdateData(FALSE);
    ...
    case IS_FRAME:
        {
            ...
            if (IS_SUCCESS == GetLastMem(&pLast, lMemoryId, lSequenceId))
            {
                ...
                if (IS_SUCCESS == nRet)
                {
                    ...
                    if (is_GetImageInfo(m_hCam, lMemoryId, &ImageInfo, sizeof(ImageInfo)) == IS_SUCCESS)
                    {
                        // Timestamp of system
                        Str.Format(L"%02d.%02d.%04d, %02d:%02d:%02d:%03d",
                        ...
                        GetDlgItem(IDC_EDIT_LOCAL_TIMESTAMP)->SetWindowText(Str);

                        UINT64 u64TimestampDevice = ImageInfo.u64TimestampDevice;
                        Str.Format(L"%I64d", u64TimestampDevice);
                        GetDlgItem(IDC_EDIT_DEVICE_TIMESTAMP)->SetWindowText(Str);
                    }
                    ...
                    GetDlgItem(IDC_EDIT_PCTIME)->SetWindowText(Str);
...
//
///////////////////////////////////////////////////////////////////////////////
void CuEyeTimestampDlg::ExitCamera()
{
    if( m_hCam != 0 )
    {
        // Disable messages
...
//
///////////////////////////////////////////////////////////////////////////////
int CuEyeTimestampDlg::InitDisplayMode()
{
    INT nRet = IS_NO_SUCCESS;
...
void CuEyeTimestampDlg::OnClose()
{
    ExitCamera();
    CDialog::OnClose();
}
...
//
///////////////////////////////////////////////////////////////////////////////
void CuEyeTimestampDlg::OnBnClickedRadioTrigger()
{
    if (!UpdateData(TRUE))
    {
        return;
...
void CuEyeTimestampDlg::GetMaxImageSize(INT *pnSizeX, INT *pnSizeY)
{
...
INT CuEyeTimestampDlg::InitCamera (HIDS *hCam, HWND hWnd)
{
...
INT CuEyeTimestampDlg::AllocImageMems(INT nSizeX, INT nSizeY, INT nBitsPerPixel)
{
    INT nRet = IS_SUCCESS;
...
INT CuEyeTimestampDlg::FreeImageMems(void)
{
    INT nRet = IS_SUCCESS;
...
INT CuEyeTimestampDlg::InitSequence(void)
{
    INT nRet = IS_SUCCESS;
...
INT CuEyeTimestampDlg::ClearSequence(void)
{
    return is_ClearSequence(m_hCam);
}

INT CuEyeTimestampDlg::GetLastMem(char** ppLastMem, INT& lMemoryId, INT& lSequenceId)
{
    INT nRet = IS_NO_SUCCESS;
