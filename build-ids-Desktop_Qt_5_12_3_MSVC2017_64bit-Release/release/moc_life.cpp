...
QT_MOC_LITERAL(5, 32, 13), // "stateSaveBCGR"
QT_MOC_LITERAL(6, 46, 9), // "startLife"
QT_MOC_LITERAL(7, 56, 8), // "stopLife"
QT_MOC_LITERAL(8, 65, 10), // "initCamera"
QT_MOC_LITERAL(9, 76, 14), // "saveBackground"
QT_MOC_LITERAL(10, 91, 1), // "n"
QT_MOC_LITERAL(11, 93, 21), // "setSubtractBackground"
QT_MOC_LITERAL(12, 115, 5) // "value"

    },
    "Life\0updateFrame\0\0float**\0frame\0"
    "stateSaveBCGR\0startLife\0stopLife\0"
...
void Life::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->startLife(); break;
        case 3: _t->stopLife(); break;
        case 4: _t->initCamera(); break;
        case 5: _t->saveBackground((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->setSubtractBackground((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
